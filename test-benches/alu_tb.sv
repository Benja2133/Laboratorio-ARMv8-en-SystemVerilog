module alu_tb();
    ...
    // Define test vectors (with correct size and format)
...
inputs_and_expected_outputs[6] = {64'h7FFF_FFFF_FFFF_FFFF, 64'd1, 4'b1010, 64'h8000_0000_0000_0000, 1'b0, 1'b1, 1'b0, 1'b1, 1'b1}; // casi igual a 4 pero setea flags
    ...
    // Load inputs on positive edge of the clock
    ...
    // Check outputs on negative edge of the clock
    ...
    // Increment vectornum and check if all tests are completed
    always @(negedge clk) begin
