...
logic [63:0] registers [0:31] = '{
	...
	always_comb
        ...
        begin
            ...
            if (we3 && ra1 != 5'b11111 && ra1 === wa3) rd1 = wd3;
					else rd1 = (ra1 === 5'b11111) ? 64'b0 : registers[ra1];
					  
				if (we3 && ra2 != 5'b11111 && ra2 === wa3) rd2 = wd3;
					else rd2 = (ra2 === 5'b11111) ? 64'b0 : registers[ra2];
